...
export function ActivityDialog() {
    ...
    const handleActivitySelectChange = React.useCallback(
        event => {
            ...
            >
                <section>
                    ...
                    >
                        ...
                        >
                            <Option icon="physical-activity" value="steps">
                                Steps
                            </Option>
                            <Option icon="DirectionsBike" value="bike">
                                Bike(km)
                            </Option>
                            <Option icon="bus-public-transport" value="bus">
                                Bus(km)
                            </Option>
                            <Option icon="passenger-train" value="train">
                                Train(km)
                            </Option>
                            <Option icon="meal" value="vegetarianMeal">
                                Vegetarian Meal
                            </Option>
                        </Select>
                        <Input
