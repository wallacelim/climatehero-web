...
export const EDIT_ACTIVITY_STARTED = "EDIT_ACTIVITY_STARTED";
...
// Series-related action
export const ADD_SERIES_STARTED = "ADD_SERIES_STARTED";
export const ADD_SERIES_SUCCESS = "ADD_SERIES_SUCCESS";
export const ADD_SERIES_FAIL = "ADD_SERIES_FAIL";

export const DELETE_SERIES_STARTED = "DELETE_SERIES_STARTED";
...
export const TOGGLE_ADD_SERIES_MODAL = "TOGGLE_ADD_SERIES_MODAL";
